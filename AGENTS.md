# AGENTS.md — AI2000 Docs Maintainer
...
| Extensions | Codex extensibility — skills, MCP servers, plugins. |
...
| `AGENTS.md` | Repo layout block + section scope table + tag vocabulary if a new tag was added. |
